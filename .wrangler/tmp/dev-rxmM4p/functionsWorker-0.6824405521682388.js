...
// .wrangler/tmp/pages-r2LIJ7/functionsWorker-0.6824405521682388.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
async function onRequestPost(context) {
  try {
    const normalizeJumpSize = /* @__PURE__ */ __name2((rawJump) => {
      const numeric = Number(rawJump);
      if (!Number.isFinite(numeric)) return 0.1;
      return Math.max(0.1, Math.round(numeric * 10) / 10);
    }, "normalizeJumpSize");
    const snapToTenth = /* @__PURE__ */ __name2((value) => Math.round(value * 10) / 10, "snapToTenth");
...
async function onRequestPost3(context) {
  ...
  const snapToTenth = /* @__PURE__ */ __name2((value) => Math.round(value * 10) / 10, "snapToTenth");
  const getDrinkCategory = /* @__PURE__ */ __name2((drinkName) => {
...
// .wrangler/tmp/bundle-Jc0eTd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Jc0eTd/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6824405521682388.js.map
